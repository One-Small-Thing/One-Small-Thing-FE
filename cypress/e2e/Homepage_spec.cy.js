describe("Homepage", () => {
  ...
  it.skip("Should allow the user to open on click", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar__main--menu--button").click();
    });
  });

  it.skip("Should display two buttons to the user", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar__main--menu--button").click();
  ...
  it.skip("Should display a list of crisis lines in to the user at the bottom", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar__main--menu--button").click();
    });
  });

  it.skip("Should have the ability to redirect the user on click", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar__main--menu--button").click();
  ...
  it.skip("Should close when a user clicks an option in the hamburger menu or when the x-button is clicked", () => {
    cy.get(".navbar").within(() => {
      cy.get(".navbar__main--menu--button").click();
      cy.get(".navbar__main--menu--button").click();
    });
  ...
  it.skip("Should display a little paragraph to the user about the page", () => {
    cy.get(".hot-topics__desc > p").should("be.visible");
  });

  it.skip("Should allow the user to see 9 tiles of topics", () => {
    cy.get('[href="/NewsStories/LGBTQ+"] > .topics__box').should("be.visible");
    cy.get('[href="/NewsStories/LGBTQ+"] > .topics__box').contains("LGBTQ+");
  });

  it.skip("Should allow the user to click on an option and be redirected to a page corresponding to the option clicked", () => {
    cy.get('[href="/NewsStories/LGBTQ+"] > .topics__box').should("be.visible");
    cy.get('[href="/NewsStories/LGBTQ+"] > .topics__box').contains("LGBTQ+");
