describe("Homepage", () => {
  ...
  it("Should have the ability to redirect the user on click", () => {
    cy.get(".navbar").within(() => {
      ...
      cy.url().should("eq", "https://one-small-thing.github.io/One-Small-Thing-FE/About");
    });
  });
  ...
  it("Should allow the user to click on an option and be redirected to a page corresponding to the option clicked", () => {
    ...
    cy.url().should("eq", "https://one-small-thing.github.io/One-Small-Thing-FE/NewsStories/LGBTQ+");
  });
});
